...
public class VoucherDB {
    ...
    public  void createNewTable() {
        ...
        String url = "jdbc:sqlite:created/VoucherDB.db";
    ...
    public Voucher loadVoucher(String voucherCode){
        ...
        try {
            ...
            voucher.discount = rs.getDouble("discount") ;
            voucher.voucherCode = rs.getString("voucherCode") ;
            voucher.voucherID =   rs.getInt("voucherID");
